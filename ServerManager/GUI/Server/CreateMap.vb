Public Class CreateMap
    ...
    Sub New(server As ServerBase, Optional editMode As Boolean = False, Optional editLevelName As String = "", Optional editLevelType As Integer = 0, Optional editLevelSeed As Long = 0, Optional editLevelGensettings As String = "")
    ...
    Private Sub LevelTypeBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles LevelTypeBox.SelectedIndexChanged
        ...
        If TypeOf server Is KettleServer Then version = "1.12.2"
        If TypeOf server Is VanillaServer Then
            Dim server = CType(Me.server, VanillaServer)
            If server.Server2ndVersion <> "" AndAlso
        ...
        Else
        End If
        If TypeOf server Is ForgeServer Then
