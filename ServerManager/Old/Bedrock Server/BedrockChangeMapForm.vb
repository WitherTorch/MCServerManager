...
Friend Class BedrockChangeMapForm
    Private _server As BedrockServer

    Sub New(ByRef server As BedrockServer)
    ...
    Private Sub ChooseMapButton_Click(sender As Object, e As EventArgs) Handles ChooseMapButton.Click
        ...
        End Using
    End Sub
    Private Sub ChooseMap(path As String, Optional create As Boolean = False)
        ...
        If mapName <> "" Then
            ...
            Select Case MsgBox("要指定種子嗎？", vbYesNo)
                ...
                Case MsgBoxResult.No
                    seed = ""
            End Select
            ChooseMap(IO.Path.Combine(_server.serverDir, mapName), True)
