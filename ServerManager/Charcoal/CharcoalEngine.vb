...
#Region "nukkitx.com/resources/categories/nukkit-plugins"
                ...
                Case RenderPageType.Nukkit_PluginMainPage
                    ...
                    client.DownloadStringAsync(uri)
#End Region
#Region "www.spigotmc.org/resources/categories/bukkit.4/"
                Case RenderPageType.Spigot_PluginListPage
                    pluginName = ""
                    Dim layout As New TableLayoutPanel
                    layout.Dock = DockStyle.Fill
                    layout.AutoScroll = True
                    ...
                    Dim e2 As New Net.DownloadStringCompletedEventHandler(Sub(sender, e)
                                                                              ...
                                                                              layout.Controls.Add(strip, 0, 0)
                                                                              Dim lastNumber As Integer
                                                                              Dim numberNode = parser.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/form[1]/div[1]/div[2]/nav[1]/a[1]")
                                                                              If numberNode.InnerText = "1" Then
                                                                                  lastNumber = parser.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/form[1]/div[1]/div[2]/nav[1]/a[4]").InnerText
                                                                              ElseIf numberNode.GetClasses().FirstOrDefault.ToLower = "text" Then
                                                                                  numberNode = parser.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/form[1]/div[1]/div[2]/nav[1]/a[2]")
                                                                                  lastNumber = parser.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/form[1]/div[1]/div[2]/nav[1]/a[5]").InnerText
                                                                              End If
                                                                              Dim targetNumber = 1
                                                                              If New System.Text.RegularExpressions.Regex("https:\/\/www.spigotmc.org\/resources\/categories\/bukkit.4\/\?page=[0-9]{1,}").IsMatch(url) Then
                                                                                  targetNumber = url.Substring(url.LastIndexOf("=") + 1)
                                                                              ElseIf url = "https://www.spigotmc.org/resources/categories/bukkit.4/" Then
                                                                                  targetNumber = 1
                                                                              Else
                                                                                  targetNumber = 0
                                                                              End If
                                                                              For i As Integer = 1 To lastNumber
                                                                                  ...
                                                                                  ElseIf Math.Sqrt((i - targetNumber) ^ 2) < 6 Then
                                                                                      ...
                                                                                      If i = 1 Then
                                                                                          AddHandler Label.Click, Sub()
                                                                                                                      LoadPage("https://www.spigotmc.org/resources/categories/bukkit.4/", RenderPageType.Spigot_PluginListPage, parent)
                                                                                                                  End Sub
                                                                                      Else
                                                                                          AddHandler Label.Click, Sub()
                                                                                                                      LoadPage("https://www.spigotmc.org/resources/categories/bukkit.4/?page=" & nowNum, RenderPageType.Spigot_PluginListPage, parent)
                                                                                                                  End Sub
                                                                                      End If
                                                                                      Label.ForeColor = SystemColors.HotTrack
                                                                                      strip.Items.Add(Label)
                                                                              ...
                                                                              Next
                                                                              Dim ci As Integer = 0
                                                                              For Each element In parser.DocumentNode.SelectNodes("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/form[1]/ol[1]/*")
                                                                                  ci += 1
                                                                                  If ci = 1 Then Continue For
                                                                                  Dim pluginItem As New PluginListItem()
                                                                                  pluginItem.Dock = DockStyle.Fill
                                                                                  ...
                                                                                  If IsNothing(iconNode) = False Then
                                                                                      Dim imageURL = iconNode.GetAttributeValue("src", "")
                                                                                      imageURL.Trim("""")
                                                                                      imageURL = New Uri(New Uri("https://www.spigotmc.org/"), imageURL).AbsoluteUri
                                                                                      If imageURL = "" Then
                                                                                          pluginItem.pluginIcon.ImageLocation = "https://static.spigotmc.org/styles/spigot/xenresource/resource_icon.png"
                                                                                      Else
                                                                                          pluginItem.pluginIcon.ImageLocation = imageURL
                                                                                      End If
                                                                                  Else
                                                                                  ...
                                                                                  End If
                                                                                  AddHandler pluginItem.pluginIcon.Click, Sub()
                                                                                                                              LoadPage(New Uri(New Uri("https://" & uri.DnsSafeHost), nameNode.GetAttributeValue("href", "")).AbsoluteUri, RenderPageType.Spigot_PluginMainPage, parent)
                                                                                                                              pluginName = System.Net.WebUtility.HtmlDecode(nameNode.InnerText.Trim)
                                                                                                                          End Sub
                                                                                  pluginItem.pluginName.Text = System.Net.WebUtility.HtmlDecode(nameNode.InnerText.Trim)
                                                                                  pluginItem.pluginName.Cursor = Cursors.Hand
                                                                                  pluginItem.pluginName.Font = New Font(New FontFamily(Drawing.Text.GenericFontFamilies.SansSerif), 18, GraphicsUnit.Pixel)
                                                                                  AddHandler pluginItem.pluginName.Click, Sub()
                                                                                                                              LoadPage(New Uri(New Uri("https://" & uri.DnsSafeHost), nameNode.GetAttributeValue("href", "")).AbsoluteUri, RenderPageType.Spigot_PluginMainPage, parent)
                                                                              ...
                                                                              Dim version = System.Environment.OSVersion.Version
                                                                              client.Headers.Add(Net.HttpRequestHeader.UserAgent,
                      "Mozilla/5.0 (Windows NT " & version.Major & "." & version.Minor & ") AppleWebKit/534.34 (KHTML, like Gecko) Charcoal/" & CHARCOAL_VER & " Safari/534.34")
                                                                          End Sub)
                    AddHandler client.DownloadStringCompleted, e2
                    client.DownloadStringAsync(New Uri(url))
                Case RenderPageType.Spigot_PluginMainPage
                    client = New Net.WebClient
                    Dim _version = System.Environment.OSVersion.Version
                    client.Headers.Add(Net.HttpRequestHeader.UserAgent,
                                                             "Mozilla/5.0 (Windows NT " & _version.Major & "." & _version.Minor & ") AppleWebKit/534.34 (KHTML, like Gecko) Charcoal/" & CHARCOAL_VER & " Safari/534.34")
                    Dim layout As New TabControl
                    layout.Dock = DockStyle.Fill
                    Dim IntroPage As New TabPage("插件內容")
                    layout.TabPages.Add(IntroPage)
                    ...
                    Dim e4 As New Net.DownloadStringCompletedEventHandler(Sub(sender, e)
                                                                              ...
                                                                              table.Dock = DockStyle.Fill
                                                                              Dim i As Integer = 0
                                                                              For Each node In parser.DocumentNode.SelectNodes("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/table[1]/*")
                                                                                  i += 1
                                                                                  If i <= 2 Then Continue For
                                                                                  Dim item As New ListViewItem("")
                                                                                  Dim node2 = node.SelectSingleNode("td[1]")
                    ...
                    Dim e2 As New Net.DownloadStringCompletedEventHandler(Sub(sender, e)
                                                                              RaiseEvent DownloadCompleted(sender, e)
                                                                              parser.LoadHtml(e.Result)
                                                                              Dim node = parser.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/ol[1]/li[1]/article[1]/blockquote[1]")
                                                                              Dim headNode = parser.DocumentNode.SelectSingleNode("/html[1]/head[1]")
                                                                              Dim p As New HtmlRenderer.WinForms.HtmlPanel
                                                                              p.Dock = DockStyle.Fill
                                                                              p.AutoScroll = True
